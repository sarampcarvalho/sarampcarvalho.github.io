...
- Oliveira, H. G., Rodrigues, R., Ferreira, B., Silvano, P. & **Carvalho, S.** (2024). [BATS-PT: Assessing Portuguese Masked Language Models in Lexico-Semantic Analogy Solving and Relation Completion](https://aclanthology.org/2024.propor-1.21/). In *Proceedings of the 16th International Conference on Computational Processing of Portuguese*, pages 207–217, Santiago de Compostela, Galicia/Spain. Association for Computational Linguistics.
